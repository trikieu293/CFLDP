...
ALPHA = 0.001            # approximation level
BETA = 1                # the distance sensitivity parameter
LAMBDA = 0.5             # the elasticity parameter
THETA = 0.9             # sensitivity parameter of the utility function
...
product = product(*[k for k in scenarios_attr.values()])
R = {}
count = 1
for item in product:
